jest.mock('../../src/hooks/useEthPrice');
jest.mock('../../src/hooks/useEthereumSWR');

import { renderHook, act } from '@testing-library/react-hooks';
import { WeiPerEther } from '@ethersproject/constants';
import { useEthPrice } from '../../src/hooks/useEthPrice';
import { useEthereumSWR } from '../../src/hooks/useEthereumSWR';
import { useTxPrice } from '../../src/hooks/useTxPrice';
